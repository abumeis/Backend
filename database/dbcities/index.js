...
//.aggregate()
//.group({
//    _id:"$department",population:{$sum:"$population"}
//})
...
//.aggregate()
//.group({
//    _id:"$department",population:{$avg:"$population"}
//})
//    .then((response) => console.log(response));
//
...
//cityModel
//.aggregate()
//    .group({_id:"$department",population: {$avg:"$population"},SumPopulation: {$sum:"$population"}})
//.sort({population:1}).then((response) => console.log(response));
